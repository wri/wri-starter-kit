...
3. On live, enable the `wri_package` and `wri_package2` modules.
...
8. Export the live configuration back to the codebase using the `config_partial_export` module at `/admin/config/development/configuration/single/config-partial-export`
